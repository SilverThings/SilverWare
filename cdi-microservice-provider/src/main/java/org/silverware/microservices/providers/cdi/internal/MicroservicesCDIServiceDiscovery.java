 ...
 */
@ApplicationScoped
public class MicroservicesCDIServiceDiscovery implements Extension {

    /**
     * Logger
     */
    private static Logger _logger = LogManager.getLogger(MicroservicesCDIServiceDiscovery.class);
    /**
...
//        }
    ...
    private void addInjectableClientProxyBean(Field injectionPointField, Microservice serviceReference, Set<Annotation> qualifiers, BeanManager beanManager) {
